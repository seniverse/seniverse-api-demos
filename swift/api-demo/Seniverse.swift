...
final class Seniverse {
    ...
    func weatherNow(location: String) -> Void {
        let url = Seniverse.getRequestURL(route: "weather/now.json", parameters: ["location" : location])
        print(" ============ Request URL ============ ")
        print(url)
        print(" ================== ")
        ...
        let task = Seniverse.session.dataTask(with: request) {
